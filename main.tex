...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {\href{https://www.usejimo.com/}{Jimo}}{Jakarta, Indonesia}  
      \resumeItemListStart
        \resumeItem{Improved user retention through Snooze and Recurrence feature, allowing users to take control of what they see}
        \resumeItem{Increased MRR by 3K EUR by revamping Changelog/Post with sleek animations using React and Framer Motion.}
        \resumeItem{Increased Survey feature usage by 40\% through integrating responses with Slack channel notifications using NestJS.}
        % \resumeItem{Fortified security and blocked masquerade attacks by adding cryptographic signature identity checking.}
      \resumeItemListEnd
...
%-------------------------------------------
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Increased revenue by 30\% by developing end-to-end Promo Code feature using Flutter, React, and Java.}
...
\section{Projects}
    \resumeSubHeadingListStart
        \resumeProjectHeading
          ...
          $|$ \emph{React, Gatsby, Tailwind, Framer Motion}}{2020 - Present}
        ...
        \resumeProjectHeading
          ...
          $|$ \emph{Blockchain, Ethers, Smart Contracts, React Native}}{2022 - 2023}
          \projectItemListStart
    ...
    %     \resumeItem{Designed and developed systems for recruitment and e-commerce app using NextJS, NodeJS, Hasura, and TailwindCSS}
        \resumeProjectHeading
          ...
          $|$ \emph{NextJS, NodeJS, Hasura, GraphQL, Tailwind}}{2020 - 2021}
          \projectItemListStart
            \resumeItem{Led a team of 12 developers with agendas such as design documents, system designs, task distribution,  and code review.}
    ...
    %       $|$ \emph{React, Chakra-UI, Django REST Framework}}{2020 - 2021}
    %       \projectItemListStart
