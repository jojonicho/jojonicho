...
\section{Education}
  \resumeSubHeadingListStart
    \educationSubheading
      ...
      {Bachelor of Science in Computer Science, GPA: 3.87/4.0}{2023}
...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      {Researcher} {Jan 2023 -- May 2023}
      {\href{https://www.ui.ac.id/}{University of Indonesia}}{Jakarta, Indonesia}
      \resumeItemListStart
        \resumeItem{Wrote thesis titled Load Balancing Analysis on App Performance in Geo-Distributed Kubernetes Clusters.}
        \resumeItem{Developed and deployed application to geo-distributed Kubernetes clusters using multi-cluster resources on GCP.}
    ...
    % \resumeSubheading
      ...
      % {\href{https://ishangry.com/}{Hangry.com}}{Jakarta, Indonesia}
      % \resumeItemListStart
      %   \resumeItem{Developed redeemable points system using NodeJS, Redis, Kafka, and Typescript.}
      % \resumeItemListEnd
