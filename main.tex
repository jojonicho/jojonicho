...
\section{Experience}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItem{Integrated Lazada PayLater API and collaborated with Lazada engineers on requirements and debugging.}
        \resumeItem{Worked with multi-national tech team members from Singapore across platforms (Tiktok Shop, Lazada).}
      \resumeItemListEnd
